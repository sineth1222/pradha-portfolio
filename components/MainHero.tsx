  ...
  return (
    <section className="relative min-h-screen flex items-center overflow-hidden">
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(ellipse 60% 80% at 8% 60%, rgba(212,160,23,0.10) 0%, transparent 70%)",
        }}
      />
      ...
      {/* ── Content ── */}
      <div className="relative z-20 w-full max-w-7xl mx-auto px-6 md:px-10 pt-28 pb-16 grid md:grid-cols-[1fr_380px] gap-14 items-center">
        {/* Left — Text */}
        <div>
          ...
          <motion.h1
            {...fadeUp(0.2)}
            className="font-serif text-6xl md:text-7xl lg:text-8xl font-bold leading-[0.92] tracking-tighter mb-6 text-white"
          >
            PraDha
            <br />
          ...
          <motion.div {...fadeUp(0.42)} className="flex flex-wrap gap-4 mb-14">
            <Link
              href="/portfolio"
              className="inline-block px-9 py-4 text-xs font-medium tracking-widest uppercase rounded-sm text-white transition-all duration-200 hover:brightness-110"
            ...
            <Link
              href="/contact"
              className="inline-block px-9 py-4 text-xs font-medium tracking-widest uppercase rounded-sm transition-all duration-200 hover:bg-white/10"
              style={{
            ...
            {[
              ...
              <div key={s.label}>
                <p className="font-serif text-4xl font-bold leading-none text-white">
                  ...
                  <span style={{ color: "#D4A017", fontSize: "1.4rem" }}>
                    {s.num.includes("+") ? "+" : "%"}
                  </span>
                </p>
                <p
        ...
        >
          ...
          >
            ...
            >
              <Link
                href="/contact"
                className="block text-center text-xs font-medium tracking-widest uppercase py-3.5 rounded-sm text-white transition-all duration-200 hover:brightness-110"
                style={{ background: "#D4A017" }}
              >
                Start a Project →
              </Link>
              <Link
                href="/portfolio"
                className="block text-center text-xs font-medium tracking-widest uppercase py-3 rounded-sm transition-all duration-200 hover:bg-white/8"
                style={{
